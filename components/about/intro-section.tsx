    ...
    <section className="py-24 md:py-32">
      <div className="max-w-5xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-semibold text-foreground mb-8 tracking-tight">
              About Me
            </h1>
            <div className="space-y-5 text-muted-foreground leading-relaxed">
              ...
              <p>
                I spend most of my time working on AWS infrastructure and Databricks deployments at Celebal Technologies in Jaipur. I like understanding systems deeply — not just making them work, but understanding <span className="text-accent">why</span> they work.
              </p>
              <p>
